...
public:
   ...
   geomRect3D(const geomVector3D& p, const geomVector3D& n, const geomVector3D& xv, const geomFRect& rect)
   {
      set(p, n, xv, rect);
   }
   ...
   void set(const geomVector3D&, const geomVector3D&, const geomVector3D&, const geomFRect&);
