...
public: /// <summary>
   ...
   mcScoreAcceleratedBeam(const char* module_name, int nThreads, enum mc_particle_t ptype, int ne, int nr, int naxial,
                          int nthet, double emin, double emax, double rmax, double thetmax);
...
protected:
   ...
   double emax_;
   double rmax_;
   double thetmax_; // Служебные переменные
   double de_;
   double dr_;
   double dthet_;
   double daxial_;
