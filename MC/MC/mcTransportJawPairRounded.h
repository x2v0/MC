...
{
public:
   mcTransportJawPairRounded(); // r - радиус скругленной части, h - толщина шторки, dx - ширина прямоугольной части
   mcTransportJawPairRounded(const geomVector3D& orgn, const geomVector3D& z, const geomVector3D& x, double r, double h,
                             double dx);
...
protected:         // Радиус скругленной части
   double r_, r2_; // Толщина шторки
   double h_;      // Ширина прямоугольной части
   double dx_;     // Размер ассиметричного поля в физических единицах
   double fsx1_, fsx2_;
   double fscenter_;
};
