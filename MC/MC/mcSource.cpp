...
mcSource::mcSource(const char* name, int nThreads) : mcObj(), trackScore_(nullptr), isGamma_(false),
                                                     isStartInside_(false)
{
   red_ = 1.0;
   green_ = 0;
...
void mcSource::setScoreTrack(double R, double Z1, double Z2, double EMIN, bool doPhotons, bool doElectrons,
                             bool doPositrons)
{
