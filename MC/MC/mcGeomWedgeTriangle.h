...
//Purpose:   ласс описани¤ геометрии простого треугольного клина.
//ѕолигон сечени¤ клина - пр¤моугольный треугольник.
...
public:
   ...
   {
      os << *static_cast<const mcGeomShape*>(&g);
...
protected:
   ...
   double xw_;      // длина клина (в направлении, перпендикул¤рном направлению клина)
};
