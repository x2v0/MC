...
mcETransportSphere::mcETransportSphere() : mcTransport(), r_(0) {}

mcETransportSphere::
mcETransportSphere(const geomVector3D& orgn, const geomVector3D& z, const geomVector3D& x,
                   double r) : mcTransport(orgn, z, x), r_(r) {}
