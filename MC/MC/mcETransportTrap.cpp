...
#include "mcScore.h"
#include "mcThread.h"
mcETransportTrap::mcETransportTrap(void) : mcTransport() {}

mcETransportTrap::
mcETransportTrap(const geomVector3D& orgn, const geomVector3D& z, const geomVector3D& x) : mcTransport(orgn, z, x) {}
