...
mcSourceXraySigmaR::mcSourceXraySigmaR(const char* name, int nThreads, mc_particle_t type, double ke, double z,
                                       double sigmar, double theta) : mcSource(name, nThreads), type_(type), q_(0),
                                                                      ke_(ke), z_(z), sigma_(sigmar * sqrt(0.5)),
                                                                      theta_(theta)
{
