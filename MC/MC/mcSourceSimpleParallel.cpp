...
mcSourceSimpleParallel::mcSourceSimpleParallel(void) : mcSource(), type_(MCP_PHOTON), ke_(0), q_(0), rx_(0), ry_(0),
                                                       sigmaKE_(0) {}

mcSourceSimpleParallel::mcSourceSimpleParallel(const char* name, int nThreads, mc_particle_t type, double ke,
                                               const geomVector3D& p, const geomVector3D& v, double rx, double ry,
                                               double sigmaKE //=0
