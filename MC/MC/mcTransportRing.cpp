...
mcTransportRing::mcTransportRing(void) : mcTransport()
{
   setGeometry(0, 0, 0);
}

mcTransportRing::mcTransportRing(const geomVector3D& orgn, const geomVector3D& z, const geomVector3D& x, double r0,
                                 double r1, double h) : mcTransport(orgn, z, x)
{
   setGeometry(r0, r1, h);
}
