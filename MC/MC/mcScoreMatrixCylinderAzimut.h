...
{
public:
   mcScoreMatrixCylinderAzimut(const char* module_name, int nThreads, int nr, int nz, double rmax, double zmin,
                               double zmax);
...
protected: // ќпределение индексов €чейки дл€ указанной точки.
