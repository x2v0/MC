...
#pragma once
#include "mcsource.h"
class mcHistogramSampler; // Model of breamstrahlung radiation beam from classical electron accelerator.
...
{
public:
   mcSourceXrayBeam(const char* name, int nThreads, double z, double enom, double sad, double x1, double x2, double y1,
                    double y2);
