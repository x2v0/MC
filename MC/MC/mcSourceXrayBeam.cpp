...
double spec_06X[] = {
   0.0186198, 0.0399641, 0.0405027, 0.0385809, 0.0362754, 0.050912, 0.058875, 0.0503812, 0.0634955, 0.0545269, 0.0264792
};
double ebins_10X[] = {0.25, 0.5, 0.75, 1, 1.25, 1.5, 2, 2.5, 3, 4, 5, 6, 7, 8, 9};
double spec_10X[] = {
   3.89224E-05, 0.013095, 0.0207605, 0.0213944, 0.0203683, 0.0285345, 0.0328886, 0.028523, 0.0372739, 0.0379239,
   0.0287197, 0.0211778, 0.0147925, 0.00925699, 0.00437173
};
double ebins_18X[] = {0.25, 0.5, 0.75, 1, 1.25, 1.5, 2, 2.5, 3, 4, 5, 6, 7, 8, 9, 10, 12, 14, 16};
double spec_18X[] = {
   1.41302E-41, 4.97089E-07, 0.00109451, 0.00599288, 0.00979936, 0.0168469, 0.0216932, 0.0188831, 0.0242913, 0.0242057,
   0.0186543, 0.0147144, 0.0117833, 0.00951739, 0.00771155, 0.00935528, 0.00793689, 0.00460063, 0.00203667
};

mcSourceXrayBeam::mcSourceXrayBeam(const char* name, int nThreads, double z, double enom, double sad, double x1,
                                   double x2, double y1, double y2) : mcSource(name, nThreads), type_(MCP_PHOTON),
                                                                      z_(z), nom_energy_(enom), sad_(sad), fsx1_(x1),
                                                                      fsx2_(x2), fsy1_(y1), fsy2_(y2),
                                                                      esampler_(nullptr)
{
