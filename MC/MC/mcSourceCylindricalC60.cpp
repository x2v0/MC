...
mcSourceCylindricalC60::mcSourceCylindricalC60(const char* name, int nThreads, const geomVector3D& p,
                                               const geomVector3D& v, double r, double h) : mcSource(name, nThreads),
                                                                                            p_(p), v_(v), r_(r), h_(h)
{
   isGamma_ = true;
}
