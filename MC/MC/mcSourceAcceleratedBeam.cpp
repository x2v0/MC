...
mcSourceAcceleratedBeam::mcSourceAcceleratedBeam(const char* name, int nThreads, double z) : mcSource(name, nThreads),
                                                                                             z_(z), nparticles_(0),
                                                                                             idx_(nThreads, 0) {}
...
void mcSourceAcceleratedBeam::loadData(istream& is)
{
   ...
   nparticles_ = static_cast<int>(particles_.size());
}
