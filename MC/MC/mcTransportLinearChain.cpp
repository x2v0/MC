...
mcTransportLinearChain(const geomVector3D& orgn, const geomVector3D& z,
                       const geomVector3D& x) : mcTransport(orgn, z, x) {}
...
void mcTransportLinearChain::completeInit()
{
   ...
   chainTransports_.back()->setNextTransport(this); // HACK!!! Нейтрализуем предыдущую установку.
