...
{
public:
   mcScoreBeamFluenceXY(const char* module_name, int nThreads, int nx, int ny, double psx, double psy, int nebins,
                        double emax);
...
public:
   ...
   double EnergyBin(int idx) const
   {
      return emax_ * (idx + 0.5) / nebins_;
   }

   int NEnergyBins() const
   {
      return nebins_;
   }
