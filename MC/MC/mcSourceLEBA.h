...
enum spectrum_distr_t { SPECTRUM_GAUSS = 0, SPECTRUM_TRIANGLE, SPECTRUM_PRISM }; // Типы радиальных профилей
...
public: // name - нзвание модуля;
   ...
   mcSourceLEBA(const char* name, int nThreads, spectrum_distr_t sptype, profile_distr_t prf_type, double kemean,
                double kewidth, double z, double rsigma);
