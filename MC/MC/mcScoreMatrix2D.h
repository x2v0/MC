...
{
public:
   mcScoreMatrix2D(const char* module_name, int nThreads, int nx, int nz, const geomVector3D& v1,
                   const geomVector3D& v2);
...
public:
   ...
   void mul(double f); //const double* GetMatrixConst() const { return m_M; }
