...
// Класс транспорта в конической пирамиде, 
...
protected:
   double r_;
   double h_; // длина грани пирамиды
   double s_; // Квадрат тангенса угла наклона конуса
   double A_; // единичный вектор в направлени грани пирамиды
   geomVector2D g_;
};
