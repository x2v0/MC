...
mcScoreEnergySpectrum::mcScoreEnergySpectrum(const char* module_name, int nThreads, mc_particle_t pt, int ne,
                                             double emax, double rmax) : mcScore(module_name, nThreads), pt_(pt),
                                                                         ne_(ne), emax_(emax), estep_(emax / ne),
                                                                         rmax_(rmax * rmax), espec_(nThreads)
{
