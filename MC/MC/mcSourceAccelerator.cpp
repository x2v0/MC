...
mcSourceAccelerator::mcSourceAccelerator(const char* name, int nThreads, mc_particle_t type, double ke, double z,
                                         double r, double theta) : mcSource(name, nThreads), type_(type), q_(0),
                                                                   ke_(ke), z_(z), r_(r), theta_(theta)
{
