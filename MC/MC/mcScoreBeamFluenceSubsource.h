...
{
public:
   mcScoreBeamFluenceSubsource(const char* name, int nThreads, enum mc_particle_t, double zmin, double zmax,
                               double focus, int nr, double rmax, int ne, double emax, int na, double amax);
