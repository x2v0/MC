...
protected:
   ...
   static void GetPairAngle(mcRng& rng, const mcMediumXE* pMedium, double eScaled_in, double ke_elec, double* cosTheta,
                            double* sinTheta);
   ...
   static void GetComptonSplit(mcRng& rng, double e_in, double* e_phot, double* cosTheta_phot, double* sinTheta_phot,
   ...
   static void GetPhotoelectricEnergies(double rnum, const mcMediumXE* pMedium, double e_in, double* e_dep,
   ...
   static void GetRayleighAngle(mcRng& rng, const mcMediumXE* pMedium, double e_phot, double* cosTheta,
                                double* sinTheta);
};
