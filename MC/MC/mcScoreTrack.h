...
protected:
   ...
   vector<vector<geomVector3D>> positrons_; // –азмеры цилиндра, ограничивающие изображение треков
   double R_, Z1_, Z2_;                     // ћинимальна€ энерги€, ниже которой треки не показываютс€
   double EMIN_;                            // ‘лаги изображаемых частиц
