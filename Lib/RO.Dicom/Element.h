...
namespace RO
{
   namespace Dicom
   {
      ...
      RODICOM_API void WriteUINT32LE(std::ostream& os, UINT32 v); // Element Base Class
      ...
      public:
         ...
         virtual void SetDataSet(std::shared_ptr<DataSet>); // Date and time functions
         ...
         virtual void GetDateTime(UINT16& year, UINT16& month, UINT16& day, UINT16& hour, UINT16& min, UINT16& sec,
                                  UINT32& tick) const;
         ...
         virtual void SetDateTime(UINT16 year, UINT16 month, UINT16 day, UINT16 hour, UINT16 min, UINT16 sec,
                                  UINT32 tick); // DEBUG
      ...
      protected: // Common for all element types utilities
      ...
      public:
         ...
         void GetDateTime(UINT16& year, UINT16& month, UINT16& day, UINT16& hour, UINT16& min, UINT16& sec,
                          UINT32& tick) const override;

         void SetDateTime(UINT16 year, UINT16 month, UINT16 day, UINT16 hour, UINT16 min, UINT16 sec,
                          UINT32 tick) override;
      }; // FL
